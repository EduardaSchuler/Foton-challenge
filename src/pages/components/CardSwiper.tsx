...
export const CardSwiper: FC<CardProps> = (props) => {
    return (
        <div className={styles.container} style={props.style} tabIndex={props.tabIndex}>
            ...
            <p className={styles.title} style={props.titleStyle}>{props.title}</p>
            <p className={styles.author} style={props.authorStyle}>{props.author}</p>
